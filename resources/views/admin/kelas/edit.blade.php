                    ...
                    <form action="{{ route('kelas.update', $kelas->id) }}" method="POST" enctype="multipart/form-data">
                        ...
                        @method('PUT') <!-- Method override untuk HTTP PUT -->
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control @error('nama_kelas') is-invalid @enderror" name="nama_kelas" id="basic-default-name"  value="{{ old('nama_kelas', $kelas->nama_kelas) }}"
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control @error('kompetensi_keahlian') is-invalid @enderror" name="kompetensi_keahlian" id="basic-default-company" value="{{ old('kompetensi_keahlian', $kelas->kompetensi_keahlian) }}"
